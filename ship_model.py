...
#load model
def load_model():
   #return torch.load("D:\\deployment\\hotdog-not-hotdog-master\\uploads/finetunned_model")
   '''model = models.vgg16(pretrained=True)
   prepare_for_finetunning(model)
   model.load_state_dict(torch.load("D:\\deployment\\hotdog-not-hotdog-master\\finetunned_model_state.pth"))'''
   resume = './net_model/weights_31_501_0.9806_0.9973.pth'
   model = MainModel()
